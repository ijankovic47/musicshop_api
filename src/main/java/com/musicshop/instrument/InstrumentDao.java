...
public interface InstrumentDao extends GenericDao<Instrument, Integer>{
	...
	List<Instrument> read(Integer familyId, Integer typeId, Integer propertyId, Integer brandId, Integer pageSize, Integer pageNumber, Double priceMin, Double priceMax);
